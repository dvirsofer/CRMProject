...
class Invoice {
	...
	public static function getLastAdded($db) {
		$q = "select get_last_invoice as last from dual";
		$result = $db->createQuery($q);
		return $result;
	}

	public static function insertRow($index, $invoice_id, $p_id, $quantity, $db) {
		$q = "begin insert_invoice_row(:invoice_id, :crow_num, :cp_id, :cquantity); end;";
		$stid = $db->parseQuery($q);
